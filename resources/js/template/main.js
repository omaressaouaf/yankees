...
!(function($) {
    ...
    if ($(".nav-menu").length) {
        ...
        $(".mobile-nav").prepend(
            '<button type="button" class="mobile-nav-close"><i class="fa fa-times"></i></button>'
        );
        $("#header").append(
    ...
    var aboutCarouselIndicators = $("#about-carousel-indicators");
    aboutCarousel
        .find(".carousel-inner")
        .children(".carousel-item")
        .each(function(index) {
            index === 0
                ? aboutCarouselIndicators.append(
                      "<li data-target='#aboutCarousel' data-slide-to='" +
                          index +
                          "' class='active'></li>"
                  )
                : aboutCarouselIndicators.append(
    ...
    aboutCarousel.on("slid.bs.carousel", function(e) {
        $(this)
            .find("h2")
