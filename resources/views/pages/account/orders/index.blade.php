                          ...
                          <div class="card p-3 mb-4 ">
                              <div class="row">
                                  <div class="col-md-2 pr-0">
                                      <img class="w-100" src="{{ $order->meals[0]->resizedImage }}"
                                  ...
                                  <div class="col-md-6">
                                      <h3>
                                          ...
                                          <a class="btn-link mr-3" data-toggle="collapse"
                                              href="#orderDetails{{ $order->id }}" role="button" aria-expanded="false"
                                  ...
                                  <div class="col-md-2 ml-auto">
                                      <h5> <span class="badge p-2   @if ($order->status ==
                                          'delivered') badge-success @elseif($order->status ==
                                              "failed")
                                          badge-danger @else badge-primary @endif
